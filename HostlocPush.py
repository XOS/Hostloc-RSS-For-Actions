...
def getcookies():
    ...
    js = js2py.EvalJs()
    headers = {'user-agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 15 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/14.1 Mobile/15E148 Safari/604.1'}
...
def post(chat_id, text):
    try:
        ...
        headers = {
            'user-agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 15 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/14.1 Mobile/15E148 Safari/604.1'}
        ...
        try:
            ...
            if result:
                headers = {'Cookie': cookiestr, 'user-agent': 'Mozilla/5.0 (iPhone; '
                                                              'CPU iPhone OS 15 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version'
...
headers = {
    ...
    'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 11_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.11 Safari/537.36',
